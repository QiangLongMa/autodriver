...
bool gnss__msg__message__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("gnss.msg._message.Message", full_classname_dest, 25) == 0);
  }
  gnss__msg__Message * ros_message = _ros_message;
  {  // header
  ...
  {  // array
    ...
    if (!std_msgs__msg__float64_multi_array__convert_from_py(field, &ros_message->array)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * gnss__msg__message__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("gnss.msg._message");
  ...
  {  // array
    PyObject * field = NULL;
    field = std_msgs__msg__float64_multi_array__convert_to_py(&ros_message->array);
    if (!field) {
      return NULL;
    }
    {
