...
#include "gnss/msg/detail/imu__rosidl_typesupport_fastrtps_c.h"
...
using _Imu__ros_msg_type = gnss__msg__Imu;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: x_linear_acceleration
  {
    cdr << ros_message->x_linear_acceleration;
  }

  // Field name: y_linear_acceleration
  {
    cdr << ros_message->y_linear_acceleration;
  }

  // Field name: z_linear_acceleration
  {
...
size_t get_serialized_size_gnss__msg__Imu(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Imu__ros_msg_type * ros_message = static_cast<const _Imu__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Imu__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_gnss__msg__Imu(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_gnss
size_t max_serialized_size_gnss__msg__Imu(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_gnss__msg__Imu(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gnss, msg, Imu)() {
