...
//                                     double target_l;
//                                     if (!closeroute) {
//                                         start_l = -1.0; end_l = -2.0;  //车道内超车能不能过去 
...
//                                     } else { //既不能直线行使也不能超车 
//                                         start_l = 1.5; end_l = 1.5;
//                                         delta_l = 0.5; target_v = 5;   //速度较慢行使 
//                                         target_l = 1.5;
//                                         LOCAL_.setPatam(gpsA,car(2),local_start_s,local_start_l,dl,ddl,
//                                                             globalPath,DpAllDistance,10,index,onlylocalpath,GlobalcoordinatesystemObsesLimitinlocal,
//                                                             start_l,end_l,delta_l,target_v,target_l,Decisionflags_, 0, false);
//                                         none = LOCAL_.GetoptTrajxy(lastOptTrajxy,lastOptTrajsd); 
//                                         if (none == 1) { //规划成功 
//                                             Decisionflags_.DecelerateFlag = false;
...
//                                             std::cout<<"planning_length: "<<planning_length<<std::endl;
//                                             LOCAL_.setPatam(gpsA,car(2),local_start_s,local_start_l,dl,ddl,
...
//             double deltaX = car(0) - optTrajxy(0,closeindex);
//             double deltaY = car(1) - optTrajxy(1,closeindex);
//             const double theta = optTrajxy(3,closeindex);
//             double error = deltaY * std::cos(theta) - deltaX * std::sin(theta);
//             return error;
//         }
